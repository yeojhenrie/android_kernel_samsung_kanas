...
#define SPRD_ION_RESERVED_SIZE (CONFIG_SPRD_ION_RESERVED_SIZE * SZ_1M)
#else
#define SPRD_ION_RESERVED_SIZE 0
#endif
       ...
       #define SPRD_ION_MEM_RAW_SIZE    (SPRD_ION_MM_SIZE + CMA_MARGIN)
#else
...
#else
       #define SPRD_ION_MEM_SIZE        (SPRD_ION_MM_SIZE + SPRD_ION_OVERLAY_SIZE + SPRD_ION_RESERVED_SIZE)
#endif
...
#ifndef CONFIG_SPRD_ION_FORCE_OVERLAY_CARVEOUT
#define SPRD_ION_OVERLAY_BASE	(SPRD_ION_MEM_BASE + SPRD_ION_MM_SIZE)
#define SPRD_ION_RESERVED_BASE	(SPRD_ION_MEM_BASE - SPRD_ION_RESERVED_SIZE)
#else
#define SPRD_ION_OVERLAY_BASE	(SPRD_ION_MEM_BASE - SPRD_ION_OVERLAY_SIZE)
#define SPRD_ION_RESERVED_BASE	(SPRD_ION_OVERLAY_BASE - SPRD_ION_RESERVED_SIZE)
#endif


#ifdef CONFIG_PSTORE_RAM
#define SPRD_RAM_CONSOLE_SIZE	0x20000
#define SPRD_RAM_CONSOLE_START	(SPRD_ION_RESERVED_BASE - SPRD_RAM_CONSOLE_SIZE)
#else
#define SPRD_RAM_CONSOLE_START	(SPRD_ION_RESERVED_BASE)
#endif
